...
export ROS_MASTER_URI="http://wm-log-1:11311"

source /opt/ros/kinetic/setup.zsh
source ~/sara_ws/devel/setup.zsh
alias pycharm="~/pycharm-2017.2.3/bin/pycharm.sh &"
alias catmake="cd ~/sara_ws ; rm -rf build ; rm -rf devel ; catkin_make ; source ~/.zshrc"
alias clion="~/clion-2017.2.2/bin/clion.sh &"
